 ...
 * file:        supervisor.cc
 * author:      
 * description: Supervisor for distributed market-based task allocation (Project topic 4)
 *
...
#define TOTAL_EVENTS_TO_HANDLE  10   // Events after which simulation stops or...
